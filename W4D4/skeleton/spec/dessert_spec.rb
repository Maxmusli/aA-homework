...
describe Dessert do
  ...
  subject(:dessert) { Dessert.new("type", 10, chef) }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do 
      expect { dessert.quantity("haha") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      ...
      expect(dessert.ingredients).to include("chicken")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Chef the Great Baker has made 10 types!")
    end
  end
